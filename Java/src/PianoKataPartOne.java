 ...
 *
 ...
 2017  "white"
 */
public class PianoKataPartOne {
    static String[] keyboard = new String[88];

    public static String blackOrWhiteKey(int keyPressCount) {
        // your code here
        int currentKey = (keyPressCount-1) % 88;
        generateKeyboard();

        return keyboard[currentKey];
    }

    static void generateKeyboard(){
        keyboard[0] = "white";
        keyboard[1] = "black";
        keyboard[2] = "white";
        ...
        while(currentIndex < 88){
            if(currentLayout % 2 == 0){
                twoBlackLayout(currentIndex);
                currentIndex += 5;
            } else{
                threeBlackLayout(currentIndex);
                currentIndex += 7;
            }
            currentLayout++;
            if(currentIndex==87){
    ...
    static void twoBlackLayout(int index){
        keyboard[index] = "white";
        keyboard[index+1] = "black";
        keyboard[index+2] = "white";
        keyboard[index+3] = "black";
        keyboard[index+4] = "white";
    }

    static void threeBlackLayout(int index){
        keyboard[index] = "white";
        keyboard[index+1] = "black";
        keyboard[index+2] = "white";
        keyboard[index+3] = "black";
        keyboard[index+4] = "white";
        keyboard[index+5] = "black";
        keyboard[index+6] = "white";
    }
}
